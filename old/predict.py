...
if __name__ == "__main__":
    ...
    readClassPath = "./Model/Keras_Classes.txt"
    loadModelPath = "./Model/Keras_15_0.1516_1.6130_1.00_0.00.h5"
    ...
    #重新調整大小
    if(img_channel == 1):
        data = data.reshape(data.shape[0], img_height, img_width, img_channel)
